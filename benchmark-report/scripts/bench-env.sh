...
#
#   bench-env.sh start     apply the benchmark settings
#   bench-env.sh stop      restore normal laptop behaviour
#   bench-env.sh check     verify without changing anything; exits nonzero if not ready
#
